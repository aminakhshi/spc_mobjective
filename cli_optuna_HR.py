...
def main():
    ...
    parser.add_argument('--solver_name', type=str, default='CustomSDE',
    ...
    # Create a single logger for the entire run
    logger = set_logger(
    ...
    logger.info("========================================")
    logger.info("Starting neuron simulation")
    ...
    #                                  storage="postgresql://address to sql database!")
